...
def get_latest_supporters():
    return do_rest(f"https://api.patreon.com/oauth2/v2/campaigns/{GDM_CAMPAIGN_ID}/members?include=currently_entitled_tiers&fields[tier]=title&fields[member]=email")
